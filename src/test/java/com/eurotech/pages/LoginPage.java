...
//    }
    ...
    public WebElement invalidCredentialsWarningMessage;
    @FindBy(xpath = "//*[.='Please include a valid email!']")
    public WebElement validEmailWarningMessage;
...
//    public List<WebElement> menuList;
    ...
    public void loginAsTeacher(String userEmail, String password) {
